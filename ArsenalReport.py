...
def GenerateReport(fname, lname, date1, date2, moves, locs, pitches, battedballs, count):
    document = Document()
...
def main():
    while (1 == 1):
        ...
        for i in range(len(pitches)):
            count += 1
        GenerateReport(fname, lname, date1, date2, releasemovement,
